...
if (!$stmt->fetch()) {
    $pdo->exec("INSERT INTO master_menus (kategori, nama_menu, url, icon, permission_key, urut, is_active) VALUES ('keuangan', 'Operasional Birokrasi', '/job-desk/keuangan', 'bi bi-graph-up-arrow', 'menu_job_desk', 20, 1)");
